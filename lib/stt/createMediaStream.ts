...
type GetPeakLevel = (analyzer: AnalyserNode) => number;
...
const getPeakLevel:GetPeakLevel = (analyzer) => {
  ...
  const createMediaStream:CreateMediaStream = (stream, isRecording, callback) => {
