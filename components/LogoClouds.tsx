    ...
    return (
      <div className="pt-24 pb-40 ">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <h2 className="text-center text-xl font-semibold text-white mb-20">
            Real-world problems seen in FAANG interviews.
          </h2>
          <div className="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-5">
            <Image
              alt="Meta"
              src="https://pngimg.com/d/meta_PNG7.png"
              width={158}
              height={48}
            ...
            <Image
              alt="Netflix"
              src="https://freepnglogo.com/images/all_img/1723823527netflix-white-logo-png.png"
              width={158}
              height={48}
