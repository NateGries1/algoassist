const Hero = () => {
return(
<div className="relative isolate px-6 lg:px-8 pb-20">
<div
  aria-hidden="true"
...
<div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-32">
  <div className="hidden sm:mb-8 sm:flex sm:justify-center">
    <div className="relative rounded-full font-normal bg-black px-5 py-1 text-sm/6 text-white ring-1 ring-gray-100/10 hover:ring-gray-300/20">
      Latest Build  ⚡  {' '}
      <a href="https://github.com/NateGries1/algoassist" className="font-semibold text-purple-500">
  ...
  <h2 className="text-center text-3xl font-medium text-gray-900 dark:text-gray-50 sm:text-6xl">Code smarter.  
    <span className="animate-text-gradient inline-flex bg-gradient-to-r from-neutral-900 via-slate-500 to-neutral-500 bg-[200%_auto] bg-clip-text leading-tight text-transparent dark:from-neutral-100 dark:via-slate-400 dark:to-neutral-400">Interview better.</span></h2>
    ...
    <div className="mt-10 flex items-center justify-center gap-x-6">
      <a
        href="/problems/SNGy8ITD0q2Cmc94bguX"
